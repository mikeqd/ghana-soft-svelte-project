<div class="relative text-herobg max-w-6xl mx-auto md:px-9 px-2 text-center">
	<div
		id="img-div"
		class="absolute sm:top-[-150px] md:top-[-250px] top-[-120px] text-center xl:top-[-600px] lg:top-[-300px] mx-auto lg:left-[11%]"
	>
		<img src="/Rectangle3.png" alt="" class="block max-w-[100%]" />
	</div>
	<p
		class="md:text-[40px] font-bold lg:pb-[45px] md:pt-[20rem] pb-[20px] lg:pt-[300px] xl:pt-[50px] text-[24px] pt-[10rem] sm:pt-[360px]"
	>
		Why choose us?
	</p>
	<div id="card-div" class="grid gap-6 grid-cols-[repeat(auto-fit,minmax(250px,1fr))]">
		<div
			class="why-div flex flex-col justify-center items-center border border-solid border-[#E3E6E9] rounded-md px-7 py-[34px]"
		>
			<img src="/add_business.png" alt="storefront-icon" class="block max-w-[100%]" />
			<p class="font-bold text-[22px] py-[8px]">Business Web App</p>
			<p class="text-bodysuptext text-[16px]">
				Streamline your business operations with our cutting-edge web app, providing seamless
				functionality and enhancing productivity for your team and customers.
			</p>
		</div>
		<div
			class="why-div flex flex-col justify-center items-center border border-solid border-[#E3E6E9] rounded-md px-7 py-[34px]"
		>
			<img src="/mms.png" alt="multimedia-icon" />
			<p class="font-bold text-[22px] py-[8px]">Excellent Graphics</p>
			<p class="text-bodysuptext text-[16px]">
				Captivating visuals that communicate your brand effectively, leaving a lasting impression on
				your audience—crafted by our expert design team.
			</p>
		</div>
		<div
			class="why-div flex flex-col justify-center items-center border border-solid border-[#E3E6E9] rounded-md px-7 py-[34px]"
		>
			<img src="/monitoring.png " alt="seo-icon" />
			<p class="font-bold text-[22px] py-[8px]">Advanced SEO</p>
			<p class="text-bodysuptext text-[16px]">
				Boost your online visibility with our advanced SEO strategies, ensuring your website ranks
				higher in search engine results and attracts targeted organic traffic
			</p>
		</div>
	</div>
	<p class="md:text-[40px] text-[24px] font-bold lg:py-[45px] md:py-[40px] md:pb-[10px] pt-[40px]">
	...
	<div class="flex lg:flex-row justify-between items-center gap-[15px] flex-col-reverse">
		<p class="text-bodysuptext px-2 text-left md:text-[18px] text-[16px] pb-[15px]">
			...
			through high-quality images. Our talented graphic designers will create captivating visuals,
			including banners, advertisements, and social media graphics. We'll also design a unique and
			memorable logo that reflects your brand's identity. Our expert developers will then craft a
			modern, user-friendly website that looks great on all devices. Contact us today for a free
			consultation and let [Your Business Name] be your partner in creating a stunning online
			presence.
		</p>
	...
	<div class="md:pb-[0px] pb-[32px]">
		...
		<div class="grid gap-6 grid-cols-[repeat(auto-fit,minmax(250px,1fr))]">
			...
			<div class="why-div flex flex-col justify-center items-center rounded-md px-7 pb-[14px]">
				...
				<p class=" text-[24px] py-[8px]">Malachi</p>
				<p class="text-bodysuptext text-[16px]">Software Engineer | Co-Founder</p>
			</div>
			<!-- Persons 2-->
			<div class="why-div flex flex-col justify-center items-center rounded-md px-7 py-[14px]">
				<img src="/person.png" alt="storefront-icon" class="block max-w-[100%]" />
				<p class=" text-[24px] py-[8px]">Christopher</p>
				<p class="text-bodysuptext text-[16px]">Mechanical Engineer/IT | Co-Founder</p>
			</div>
			<!-- Persons 3-->
			<div class="why-div flex flex-col justify-center items-center rounded-md px-7 py-[14px]">
				<img src="/person.png" alt="storefront-icon" class="block max-w-[100%]" />
				<p class=" text-[24px] py-[8px]">KuKuu</p>
				<p class="text-bodysuptext text-[16px]">CEO Anger Management Int</p>
			</div>
		</div>
	</div>
</div>
